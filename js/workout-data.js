        ...
        exercises: [
...

            {
                ...
                instructions: [
                    ...
                    "دسته را با عضلات پشت به سمت ران‌ها پایین بکش.",
...

            {
                ...
                instructions: [
                    ...
                    "در پایین حرکت آرنج‌ها را بیش از حد پایین نبَر."
                ]
            },
            ...
            {
                id: "rear_delt_fly",
                name: "نشر خم / پشت سرشانه",
                target: "2 × 12–15",
                rest: "60–90 ثانیه",
                sets: 2,
                images: [],
                instructions: [
                    "بدن را به جلو خم و کمر را ثابت نگه دار.",
                    "دمبل‌ها را با کنترل به طرفین باز کن.",
                    "تمرکز حرکت روی پشت سرشانه باشد، نه تاب دادن وزنه."
                ]
            },

            {
                id: "pallof_press",
                name: "Pallof Press",
                target: "3 × 10–12 هر طرف",
                rest: "45–60 ثانیه",
                sets: 3,
                images: [],
                instructions: [
                    "بدن را مقابل کابل ثابت نگه دار.",
                    "دسته را از جلوی سینه به سمت جلو فشار بده.",
                    "اجازه نده چرخش کابل بدن را به طرفین بچرخاند."
                ]
            }
